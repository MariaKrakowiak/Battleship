...
import static battleship.Player2.*;
import static battleship.Main.*;
import static battleship.Player2.arr1;
import static battleship.Main.licznik;

public class Player1 {

    public static String[][] arr;

    /*static String[][] sea1 = new String[0][];*/
  ...
  /*  static ArrayList Aircraft1 = new ArrayList();
    static ArrayList Cruiser1 = new ArrayList();
    static ArrayList Destroyer1 = new ArrayList();
    static ArrayList Submarine1 = new ArrayList();
    static ArrayList Battleship1 = new ArrayList();
    static ArrayList All1 = new ArrayList();*/

    public static void createAircraft(String[][] arr) throws ArrayIndexOutOfBoundsException {
...
/*        System.out.println(first.matches(reg1));
   ...
   /*     System.out.println(pierwszy);
    ...
    public static void createShoot(String[][] arr) throws NullPointerException {

  /*      System.out.println(Arrays.deepToString(arr));
        System.out.println(Arrays.deepToString(Project55.sea));
        System.out.println(Arrays.deepToString(Player2.arr1));
...
/*        boolean a1 = s5.equalsIgnoreCase("X") && s6.equalsIgnoreCase("X") && s7.equalsIgnoreCase("X") && s8.equalsIgnoreCase("X") && s9.equalsIgnoreCase("X");
        boolean f1 = s10.equalsIgnoreCase("X") && s11.equalsIgnoreCase("X") && s12.equalsIgnoreCase("X") && s13.equalsIgnoreCase("X");
        boolean j1 = s14.equalsIgnoreCase("X") && s15.equalsIgnoreCase("X") && s16.equalsIgnoreCase("X");
        boolean m1 = s17.equalsIgnoreCase("X") && s18.equalsIgnoreCase("X") && s19.equalsIgnoreCase("X");
        boolean p1 = s20.equalsIgnoreCase("X") && s21.equalsIgnoreCase("X");*/
...
/*        boolean c1 = sea[0][0].equals("X");
        boolean c2 = sea[1][0].equals("X");
        boolean c3 = sea[2][0].equals("X");
        boolean c4 = sea[3][0].equals("X");
        boolean c5 = sea[5][2].equals("X");
        boolean c6 = sea[5][3].equals("X");
        boolean c7 = sea[5][4].equals("X");
        boolean c8 = sea[5][5].equals("X");
        boolean c9 = sea[5][6].equals("X");
        boolean c10 = sea[1][8].equals("X");
        boolean c11 = sea[2][8].equals("X");
        boolean c12 = sea[3][8].equals("X");
        boolean c13 = sea[8][1].equals("X");
        boolean c14 = sea[9][1].equals("X");
        boolean c15 = sea[9][7].equals("X");
        boolean c16 = sea[9][8].equals("X");
        boolean c17 = sea[9][9].equals("X");*/
  ...
  /*          boolean c1 = sea[0][0].equals("X");
       ...
       /*     boolean ship1 = c1 && c2 && c3 && c4;
            boolean ship2 = c5 && c6 && c7 && c8 && c9;
            boolean ship3 = c10 && c11 && c12;
            boolean ship4 = c13 && c14;
            boolean ship5 = c15 && c16 && c17;

            boolean res1 = !ship2 && !ship1 && !ship3 && !ship4 && !ship5;
            boolean res2 = ship2 || ship1 || ship3 || ship4 || ship5;*/

           /* ship1 = c1 && c2 && c3 && c4;
            ship2 = c5 && c6 && c7 && c8 && c9;
            ship3 = c10 && c11 && c12;
            ship4 = c13 && c14;
            ship5 = c15 && c16 && c17;*/


                if (first.matches(reg1) && second.matches(reg2) && sea[Character.getNumericValue(c) - 10][Integer.parseInt(second) - 1].equals("O")) {
                    licznik++;
                ...
                }else if(first.matches(reg1) && second.matches(reg2) && sea[Character.getNumericValue(c) - 10][Integer.parseInt(second) - 1].equals("X")){
                ...
                if (first.equals("g") && second.equals("8") && sea[Character.getNumericValue(c) - 10][Integer.parseInt(second) - 1].equals("~")) {
...
//test
       /*     if (first.equals("c") && second.equals("9") && sea[Character.getNumericValue(c) - 10][Integer.parseInt(second) - 1].equals("X")) {
                sea[Character.getNumericValue(c) - 10][Integer.parseInt(second) - 1] = "X";
                ...
                if (first.matches(reg1) && second.matches(reg2) && sea[Character.getNumericValue(c) - 10][Integer.parseInt(second) - 1].equals("~")) {
                ...
                if (first.matches(reg1) && s22.matches(reg2) && sea[Character.getNumericValue(c) - 10][Integer.parseInt(s22) - 1].equals("~") && !second.equals("10")) {
                ...
                if (first.matches(reg3) && s22.matches(reg4) && sea[Character.getNumericValue(c) - 10][Integer.parseInt(s22) - 1].equals("O")) {
                    licznik++;
                ...
                } else if (first.matches(reg3) && s22.matches(reg4) && sea[Character.getNumericValue(c) - 10][Integer.parseInt(s22) - 1].equals("X")) {
                    System.out.println("Wrong coordinates!");
                    System.out.println("Press Enter and pass the move to another player");
                    reader.nextLine();
                    createShoot1(arr1);
                ...
                if (first.matches(reg3) && second.matches(reg2) && sea[Character.getNumericValue(c) - 10][Integer.parseInt(second) - 1].equals("O")) {
                    licznik++;
                    sea[Character.getNumericValue(c) - 10][Integer.parseInt(second) - 1] = "X";
                ...
                }else if (first.matches(reg3) && second.matches(reg2) && sea[Character.getNumericValue(c) - 10][Integer.parseInt(second) - 1].equals("X")){
                    System.out.println("Wrong coordinates!");
                    System.out.println("Press Enter and pass the move to another player");
                    reader.nextLine();
                    createShoot1(arr1);
                }
         /*   System.out.println(sea[Character.getNumericValue(c) - 10][Integer.parseInt(second) - 1]);
            System.out.println(sea[Character.getNumericValue(c) - 9][Integer.parseInt(second) - 1]);
            System.out.println(sea[Character.getNumericValue(c) - 8][Integer.parseInt(second) - 1]);
            System.out.println(sea[Character.getNumericValue(c) - 7][Integer.parseInt(second) - 1]);
            System.out.println(sea[Character.getNumericValue(c) - 6][Integer.parseInt(second) - 1]);
*/
